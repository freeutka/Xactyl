...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for Xactyl.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="xactyl:guzzle:connect_timeout" value="{{ old('xactyl:guzzle:connect_timeout', config('xactyl.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="xactyl:guzzle:timeout" value="{{ old('xactyl:guzzle:timeout', config('xactyl.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="xactyl:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('xactyl:client_features:allocations:enabled', config('xactyl.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="xactyl:client_features:allocations:range_start" value="{{ old('xactyl:client_features:allocations:range_start', config('xactyl.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="xactyl:client_features:allocations:range_end" value="{{ old('xactyl:client_features:allocations:range_end', config('xactyl.client_features.allocations.range_end')) }}">
