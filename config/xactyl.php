...
return [
    ...
    */
    ...
    | standard Xactyl shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://raw.githubusercontent.com/freeutka/Xactyl-site/refs/heads/main/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('XACTYL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('XACTYL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('XACTYL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('XACTYL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('XACTYL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('XACTYL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('XACTYL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('XACTYL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('XACTYL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('XACTYL_SEND_REINSTALL_NOTIFICATION', true),
    ],
