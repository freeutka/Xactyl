...
namespace Xactyl\Repositories\Wings;
...
use Xactyl\Exceptions\Http\Server\FileSizeTooLargeException;
...
class DaemonFileRepository extends DaemonRepository
{
     ...
     * @throws \Xactyl\Exceptions\Http\Server\FileSizeTooLargeException
