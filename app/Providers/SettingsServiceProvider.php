...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'xactyl:guzzle:timeout',
        'xactyl:guzzle:connect_timeout',
        'xactyl:console:count',
        'xactyl:console:frequency',
        'xactyl:auth:2fa_required',
        'xactyl:client_features:allocations:enabled',
