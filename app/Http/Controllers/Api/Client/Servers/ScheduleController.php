...
use Xactyl\Services\Schedules\ProcessScheduleService;
use Xactyl\Transformers\Api\Client\ScheduleTransformer;
use Xactyl\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use Xactyl\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \Xactyl\Models\Schedule $model */
