...
use Xactyl\Services\Subusers\SubuserCreationService;
use Xactyl\Repositories\Wings\DaemonServerRepository;
use Xactyl\Transformers\Api\Client\SubuserTransformer;
use Xactyl\Http\Controllers\Api\Client\ClientApiController;
use Xactyl\Exceptions\Http\Connection\DaemonConnectionException;
use Xactyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Xactyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Xactyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Xactyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Xactyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
