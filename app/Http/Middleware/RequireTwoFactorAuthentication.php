...
namespace Xactyl\Http\Middleware;

use Illuminate\Support\Str;
use Illuminate\Http\Request;
use Prologue\Alerts\AlertsMessageBag;
use Xactyl\Exceptions\Http\TwoFactorAuthRequiredException;
...
class RequireTwoFactorAuthentication
{
     ...
     *
     * @throws \Xactyl\Exceptions\Http\TwoFactorAuthRequiredException
     */
    public function handle(Request $request, \Closure $next): mixed
    {
        /** @var \Xactyl\Models\User $user */
        $user = $request->user();
        ...
        $level = (int) config('xactyl.auth.2fa_required');
