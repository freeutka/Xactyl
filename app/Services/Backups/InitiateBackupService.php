...
namespace Xactyl\Services\Backups;
...
use Xactyl\Extensions\Backups\BackupManager;
use Xactyl\Repositories\Eloquent\BackupRepository;
use Xactyl\Repositories\Wings\DaemonBackupRepository;
use Xactyl\Exceptions\Service\Backup\TooManyBackupsException;
...
class InitiateBackupService
{
     ...
     *
     * @throws \Throwable
     * @throws \Xactyl\Exceptions\Service\Backup\TooManyBackupsException
    ...
    public function handle(Server $server, string $name = null, bool $override = false): Backup
    {
        ...
        if (!$server->backup_limit || $successful->count() >= $server->backup_limit) {
            ...
            /** @var \Xactyl\Models\Backup $oldest */
        ...
        return $this->connection->transaction(function () use ($server, $name) {
            /** @var \Xactyl\Models\Backup $backup */
